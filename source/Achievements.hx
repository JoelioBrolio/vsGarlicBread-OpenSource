...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		["The Trials Begin",	"Open the game.",							 false],
		["Trials Completed",		"Complete Week BREAD.",					false],
		["Mallet Go BRRRRRR",				"Complete the Secret Week.",					false],
		["unused",			"Beat Week 3 on Hard with no Misses.",					true],
		["unused",					"Beat Week 4 on Hard with no Misses.",					true],
		["unused",			"Beat Week 5 on Hard with no Misses.",					true],
		["unused",					"Beat Week 6 on Hard with no Misses.",					true],
		["unused",		"Beat Week 7 on Hard with no Misses.",					true],
		["Toasted",	"Complete Toasty without any misses.",		false],
		["Bitten",				"Complete Crunch without any misses.",				false],
		["Literally Impossible How The Hell Did You Do This",			"Complete Kneaded without any misses.",				false],
		["Spontaneous Combustion",		"Complete Week BREAD with a toaster. (or just low graphics settings)",						false],
		["hm yes pro",					"Complete Tutorial on Easy with a rating less than 30%.",					false],
